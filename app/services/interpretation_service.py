...
from app.models.schemas import InterpretacionCompleta, InterpretacionResumen, InterpretacionAreasDeVida, InterpretacionTransitos, HoroscoposDelDia, HoroscoposDeLaSemana
