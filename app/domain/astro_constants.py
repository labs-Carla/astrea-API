"""
Tablas de referencia astrológica: constantes de dominio puro, sin ninguna
dependencia externa. Antes vivían mezcladas con `Settings` (config de
entorno) en `app/core/config.py` — separadas para que el paquete de
dominio no dependa de nada relacionado a configuración/infraestructura.
"""
