...
class ProximosMeses(BaseModel):
    carrera: str = Field(..., min_length=80, max_length=500, description="Que viene en los proximos 3-6 meses en el area de carrera/vocacion")
    amor: str = Field(..., min_length=80, max_length=500, description="Que viene en los proximos 3-6 meses en el area de amor/relaciones")
    dinero: str = Field(..., min_length=80, max_length=500, description="Que viene en los proximos 3-6 meses en el area de dinero/recursos")
    crecimiento: str = Field(..., min_length=80, max_length=500, description="Que viene en los proximos 3-6 meses en el area de crecimiento personal/interior")


class InterpretacionTransitos(BaseModel):
    clima_energetico: str = Field(..., min_length=100, max_length=700, description="Descripcion general del clima energetico actual segun los transitos activos")
    ...
    oportunidades: str = Field(..., min_length=80, max_length=500, description="Oportunidades que ofrece el momento actual segun los transitos")
    retos: str = Field(..., min_length=80, max_length=500, description="Retos o tensiones del momento actual segun los transitos")
    consejo: str = Field(..., min_length=60, max_length=400, description="Consejo practico y accionable para navegar este momento")
